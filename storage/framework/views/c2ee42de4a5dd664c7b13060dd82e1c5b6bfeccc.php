...
<head>
    ...
    <title><?php echo e($title); ?> | <?php echo $__env->yieldContent('title','Vendor login'); ?></title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                ...
                <div class="col-lg-4 col-12 pt-5 col-md-6 order-lg-2 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark mb-5 font-weight-normal"><?php echo e(__('Welcome to ')); ?><span class="font-weight-bold"><?php echo e(__('Restaurant')); ?></span>
                        </h4>
                        <?php if($errors->any()): ?>
                        ...
                        <?php endif; ?>
                        <form method="POST" action="<?php echo e(url('vendor/vendor_confirm_login')); ?>">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="text-center">
                            <a href="<?php echo e(url('vendor/forgot_password')); ?>" class="text-small mt-2">
                        ...
                        <div class="text-muted text-center mt-2">
                            ...
                            <a href="<?php echo e(url('vendor/register_vendor')); ?>"><?php echo e(__('Register')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\resources\views/vendor/vendor_login.blade.php ENDPATH**/ ?>